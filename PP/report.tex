...
why Erlang was chosen for this application and section~\ref{sec:erlang-eval}
...
I expect this program to scale linearly while increasing number of cores.
However, logarithmic speedup is observed with a cap of ~12, like shown in
