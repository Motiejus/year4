...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/relative_core_performance.png}
...
formally described by Amdalh's law:
...
of cores. Figure~\ref{fig:serial_speedup} illustrates the impact of serial
percentage of code on parallel speedup.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{images/serial_speedup.png}
